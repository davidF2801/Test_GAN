...
class SolarPowerExample:
    ...
    ## Wasserstein losses
    #def discriminator_wasserstein_loss(self,real_output, fake_output):
    ...
    def train(self):
      # Initialize the GAN training process
        ...
        plt.ylabel('Loss')
        plt.legend()
        plt.savefig(r'C:\Users\dfornosf\Documents\TEST_GAN\Results\Losses\gl.png')
        plt.show()
        ...
        plt.ylabel('Cost')
        plt.legend()
        plt.savefig(r'C:\Users\dfornosf\Documents\TEST_GAN\Results\Losses\cost.png')
        plt.show()
        ...
        plt.legend()
        plt.savefig(r'C:\Users\dfornosf\Documents\TEST_GAN\Results\Losses\pow.png')
        plt.show()
        ...
        plt.legend()
        plt.savefig(r'C:\Users\dfornosf\Documents\TEST_GAN\Results\Losses\per.png')
        plt.show()
        ...
        plt.ylabel('Loss')
        plt.legend()
        plt.savefig(r'C:\Users\dfornosf\Documents\TEST_GAN\Results\Losses\dl.png')
        plt.show()
...
GAN.generator.save('generator_model_'+model_name+'.h5')



## Load the saved generator model
#generator = load_model('generator_'+model_name+'.h5', custom_objects={'generator_total_loss': GAN.generator_total_loss, 'discriminator_loss':GAN.discriminator_loss, 'genarator_loss':GAN.generator_loss})
generator = load_model('generator_model_'+model_name+'.h5', custom_objects={'generator_total_loss': GAN.generator_total_loss, 'discriminator_loss':GAN.discriminator_loss, 'genarator_loss':GAN.generator_loss})
# Generate designs
...
df.to_csv('generated_designs_'+model_name+'.csv', index=False)
